...
export const POSE_DATATYPE = "geometry_msgs/Pose";
export const POSE_ARRAY_DATATYPE = "geometry_msgs/PoseArray";
export const POSE_STAMPED_DATATYPE = "geometry_msgs/PoseStamped";
export const POSE_WITH_COVARIANCE_DATATYPE = "geometry_msgs/PoseWithCovariance";
export const POSE_WITH_COVARIANCE_STAMPED_DATATYPE = "geometry_msgs/PoseWithCovarianceStamped";
